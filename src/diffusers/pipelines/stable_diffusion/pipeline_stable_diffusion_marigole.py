...
class StableDiffusionPipeline(
    ...
    def __call__(
        ...
        **kwargs,
        ...
        latents_np = np.load('/sensei-fs/users/wchao/Codes/diffusers/resutls/test_visualization_rand_render_test_ave/latent_codes_srgb_comparisons_candle_1.npy')
        ...
        if not output_type == "latent":
            ...
            np.save('/sensei-fs/users/wchao/Codes/diffusers/resutls/test_visualization_rand_render_test_ave/latent_codes_srgb_comparisons_candle_2.npy', latens_scaling_np)
