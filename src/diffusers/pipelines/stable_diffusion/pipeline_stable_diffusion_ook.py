...
class StableDiffusionPipeline(
    ...
    def __call__(
        ...
        **kwargs,
        ...
        image_tensor = preprocess_image('/sensei-fs/users/wchao/Codes/Ours/under_exposed_images/img_11_0.png', device = device)#preprocess_image('/sensei-fs/users/wchao/Codes/Ours/over_exposed_images/IMG_6568.JPG', device = device)#preprocess_image('/sensei-fs/users/wchao/Codes/Ours/over_exposed_images/P1011321.JPG', device = device)#
        ...
        if not output_type == "latent":
            ...
            with torch.no_grad():
                latent_merged, weights_map = net(latents_tensor, latents, latents_low)#net(latents_low, latents, latents_tensor)
