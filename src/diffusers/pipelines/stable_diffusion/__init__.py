...
try:
    ...
    _import_structure["pipeline_stable_diffusion_hdr"] = ["StableDiffusionHDRPipeline"]
    _import_structure["pipeline_stable_diffusion_itm"] = ["StableDiffusionITMPipeline"]
    _import_structure["pipeline_stable_diffusion_itm_under_exposure"] = ["StableDiffusionITMUNPipeline"]
    _import_structure["pipeline_stable_diffusion_itm_five"] = ["StableDiffusionITMFivePipeline"] 
    _import_structure["pipeline_stable_diffusion_itm_two"] = ["StableDiffusionITMTWOPipeline"]     
try:
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_stable_diffusion_hdr import StableDiffusionHDRPipeline
        from .pipeline_stable_diffusion_itm import StableDiffusionITMPipeline
        from .pipeline_stable_diffusion_itm_under_exposure import StableDiffusionITMUNPipeline
        from .pipeline_stable_diffusion_itm_five import StableDiffusionITMFivePipeline
        from .pipeline_stable_diffusion_itm_two import StableDiffusionITMTWOPipeline        
