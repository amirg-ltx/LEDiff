...
class StableDiffusionPipeline(
    ...
    def __call__(
        ...
        **kwargs,
        ...
        latents_np = np.load('/HPS/RawDiff/work/LED/MVDiffusion/outputs/latents_indoor.npy')#np.load('/HPS/RawDiff/work/LED/T2I_LDR/latent_code_LDR_3.npy')#np.load('/sensei-fs/users/wchao/Codes/diffusers/resutls/test_visualization_rand_render_test_ave/latent_codes_srgb_comparisons_night_scene_cars_5.npy')
        latents_tensor = torch.from_numpy(latents_np).float().to(device) * self.vae.config.scaling_factor
        latents_tensor = latents_tensor.view(1, 4, 64 * 8, 64)
