...
try:
    ...
    _import_structure["stable_diffusion"].extend(
        [
            ...
            "StableDiffusionHDRPipeline",
            "StableDiffusionITMPipeline",
            "StableDiffusionITMUNPipeline",
            "StableDiffusionITMFivePipeline",
            "StableDiffusionITMTWOPipeline",
        ]
    )
    ...
    _import_structure["stable_video_diffusion"] = (["StableVideoDiffusionPipeline",
                                                        "StableVideoDiffusionITMPipeline"])
